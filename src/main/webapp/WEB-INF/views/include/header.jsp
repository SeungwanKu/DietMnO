        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="/community/listPage"><i class="fa fa-circle-o"></i>커뮤니티</a></li>
                <li><a href="/fooddic/listPage"><i class="fa fa-circle-o"></i>음식사전</a></li>
                <li><a href="/ht/listPage"><i class="fa fa-circle-o"></i>홈트레이닝</a></li>
				   <li><a href="/diet/listPage"><i class="fa fa-circle-o"></i>식단등록</a></li>             
			</ul>
            </li>
            <li class="treeview">
              <a href="#">
                <i class="fa fa-table"></i> <span>bmi</span>
                <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li><a href="/"><i class="fa fa-circle-o"></i> 비만도 계산</a></li>
                <li><a href="/"><i class="fa fa-circle-o"></i> 내역보기</a></li>
              </ul>
            </li>
            <li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="/community/listPage">글목록</a></li>
